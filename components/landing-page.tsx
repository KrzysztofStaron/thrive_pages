    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-zinc-900 to-zinc-800">
      <header className="px-4 lg:px-6 h-14 flex items-center relative">
        ...
        <nav className="hidden lg:flex ml-auto gap-6">
          <Link className="text-sm font-medium hover:underline underline-offset-4 text-zinc-200" href="#features">
            Features
          </Link>
          <Link className="text-sm font-medium hover:underline underline-offset-4 text-zinc-200" href="#analytics">
            Analytics
          </Link>
          <Link className="text-sm font-medium hover:underline underline-offset-4 text-zinc-200" href="#contact">
            Contact
          </Link>
        </nav>
        ...
        {/* Mobile navigation */}
        {isMenuOpen && (
          <div className="absolute top-14 left-0 right-0 bg-zinc-900 p-4 lg:hidden z-50">
            <nav className="flex flex-col gap-4">
              <Link
                className="text-sm font-medium hover:underline underline-offset-4 text-zinc-200"
                href="#features"
      ...
      <main className="flex-1">
        <section
          className="w-full py-16 md:py-24 lg:py-32 xl:py-48 flex justify-center border-b border-zinc-800"
          id="about"
        >
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-6 md:space-y-4">
              <div className="space-y-4 md:space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-zinc-300 text-sm md:text-xl pt-2">
        ...
        <section
          className="w-full py-16 md:py-24 lg:py-32 bg-zinc-800 flex justify-center border-b border-zinc-700"
          id="features"
        >
          <div className="container px-4 md:px-6">
            <div className="space-y-12 md:space-y-0">
              <div className="grid gap-10 md:gap-8 sm:grid-cols-2 lg:grid-cols-3">
                <div className="flex flex-col items-center space-y-4 p-6 md:p-4 rounded-lg bg-zinc-900/50 md:bg-transparent">
        ...
        <section className="w-full py-16 md:py-24 lg:py-32 flex justify-center border-b border-zinc-800">
          <div className="container px-4 md:px-6">
            <div className="grid gap-12 lg:gap-20 lg:grid-cols-2">
              <div className="space-y-6 md:space-y-4">
                ...
                <p className="mx-auto max-w-[600px] text-zinc-300 text-sm md:text-lg lg:text-base xl:text-lg">
              ...
              <div className="flex flex-col justify-center space-y-6 md:space-y-4">
                <div className="flex items-start md:items-center space-x-4 rounded-lg border p-6 md:p-4 border-zinc-700 bg-zinc-900/50 md:bg-transparent">
                  <BarChart className="h-6 w-6 text-blue-400 flex-shrink-0" />
                  <div className="space-y-2 md:space-y-1">
                    <h3 className="font-bold text-white">Progress Reports</h3>
                    <p className="text-sm text-zinc-300">Get a snapshot of your week and month.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start md:items-center space-x-4 rounded-lg border p-6 md:p-4 border-zinc-700 bg-zinc-900/50 md:bg-transparent">
                  ...
                  <div className="space-y-2 md:space-y-1">
                    ...
                    <p className="text-sm text-zinc-300">A clean, focused interface for your daily reflections.</p>
                  </div>
                </div>
                <div className="flex items-start md:items-center space-x-4 rounded-lg border p-6 md:p-4 border-zinc-700 bg-zinc-900/50 md:bg-transparent">
