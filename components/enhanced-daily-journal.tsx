...
export function EnhancedDailyJournal() {
  const [quote, author] = useQuote();

  const [noFap, setNoFap] = React.useState(false);
  const [wellbeing, setWellbeing] = React.useState(5);
  ...
  const [suckingThing, setSuckingThing] = React.useState("");
